...
/// to Facet-generated types, and fluent navigation builders.
/// </summary>
...
public static class FacetDbContextExtensions
{
    ...
    /// <returns>A queryable that can be used to build fluent navigation queries</returns>
    /// <exception cref="ArgumentNullException">Thrown when context is null</exception>
    /// <exception cref="InvalidOperationException">Thrown when TDto doesn't have a Projection property</exception>
    public static IQueryable<TEntity> Facet<TEntity, TDto>(this DbContext context)
        where TEntity : class
        where TDto : class
    {
        if (context is null) throw new ArgumentNullException(nameof(context));
