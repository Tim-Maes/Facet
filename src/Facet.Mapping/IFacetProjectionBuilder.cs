...
public interface IFacetProjectionBuilder<TSource, TTarget>
{
    ...
    /// </summary>
    /// <typeparam name="TTargetValue">The target property value type (may be nullable).</typeparam>
    /// <typeparam name="TSourceValue">The source expression return type (may be non-nullable).</typeparam>
    ...
    IFacetProjectionBuilder<TSource, TTarget> Map<TTargetValue, TSourceValue>(
