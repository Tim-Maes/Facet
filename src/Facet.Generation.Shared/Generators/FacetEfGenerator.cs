...
/// </summary>
/// <remarks>
/// The 2025 original carried a hand-rolled AppDomain.AssemblyResolve hook here to load
/// Newtonsoft.Json and friends from the analyzer directory. That machinery is exactly what
/// SourceGenerator.Foundations now provides properly (embedded dependencies + resolver), so
/// the port drops it; a revived generator should be an SGF <c>IncrementalGenerator</c> like
/// GenerateDtosGenerator.
/// </remarks>
