...
public sealed class FacetGenerator : IIncrementalGenerator
{
    ...
    private static void GenerateFileHeader(StringBuilder sb)
    {
        ...
        var version = typeof(FacetGenerator).Assembly.GetName().Version?.ToString() ?? "Unknown";

        sb.AppendLine("// <auto-generated>");
        sb.AppendLine($"//     This code was generated by the Facet source generator v{version}.");
