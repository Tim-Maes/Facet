...
public partial class EmployeeDto
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EmployeeDto"/> class from the specified <see cref="Employee"/>.
    /// </summary>
    /// <param name="source">The source <see cref="Employee"/> object to copy data from.</param>
    public EmployeeDto(global::Facet.UnitTests.TestFixtures.Employee source)
    {
    ...
    /// <summary>
    /// Gets the projection expression for converting <see cref="Employee"/> to <see cref="EmployeeDto"/>.
    ...
    /// <example>
    /// <code>
    /// var dtos = context.Employees
    ///     .Where(x => x.IsActive)
    ///     .Select(EmployeeDto.Projection)
    ///     .ToList();
    /// </code>
    /// </example>
    public static Expression<Func<global::Facet.UnitTests.TestFixtures.Employee, EmployeeDto>> Projection =>
        source => new EmployeeDto(source);
}
