...
[Facet(typeof(CompanyEntity), NestedFacets = [typeof(AddressFacet)])]
public partial record CompanyFacet;

[Facet(typeof(StaffMember), exclude: ["PasswordHash", "Salary"], NestedFacets = [typeof(CompanyFacet), typeof(AddressFacet)])]
